...
/* 3 Columns Layout */
.product-grid{padding-right:12px; padding-left:12px}
...
ul#cart-sidebar .btn-primary, ul#cart-sidebar .btn-danger {
...
#nav > li:hover > a span {	-webkit-transition: all 0.3s cubic-bezier(0.8, 0, 0, 1);
	-o-transition: all 0.3s cubic-bezier(0.8, 0, 0, 1);
	transition: all 0.3s cubic-bezier(0.8, 0, 0, 1);
	-webkit-box-shadow: inset 0 -75px 0 0 #fff;
...
#nav > li:first-child a span {border:1px #fff solid}
.cms-index-index nav {
	border-bottom: none
}
#nav {
...
.ratings p{ margin:0px}

.ratings a {margin-left:10px}
...
.top-cate .new_title { text-align:center;  border-bottom:1px #e5e5e5 solid; height:30px; }
...
#top-categories .owl-item .item {margin:0px}
...
.cate-banner-img {position: absolute;
    z-index: 100;
    left: 50%;
    margin-left: -110px;top: 83px;}
...
.btn-cart {padding:0px!important; border:1px #ddd solid; color:#333}
.btn-cart:before { content:'\f07a'; font-family: FontAwesome; color:#333; font-size:16px; padding:6px 0px 6px 10px; display:inline-block; }
...
.tmblog-article-view #content { margin-top:0px!important}

.blog-wrapper header{ z-index:auto}

.blog-wrapper .entry-date{background:#fff; color:#333; padding:10px 15px; font-family:'Montserrat', sans-serif; text-transform:uppercase; position:absolute; right:20px; top:18px; border:1px #eee solid}

.blog-wrapper p {padding:10px 0px}
...
.blog_entry-title {margin-top:0px; font-family:'Montserrat', sans-serif; text-transform:uppercase; font-weight:700; font-size:24px; border-bottom:1px #eee solid; padding-bottom:15px; margin-bottom:20px}
...
.return-policy{margin-right: 0!important; }
...
.product-view .flexslider-thumb .flex-prev:hover {
	...
	-o-transition: all 0.4s cubic-bezier(0.8, 0, 0, 1);
	transition: all 0.4s cubic-bezier(0.8, 0, 0, 1);
	box-shadow: inset 0 -40px 0 0 #E0403D;
	border: 1px solid #E0403D;
	color: #fff!important
}
...
.checkout-progress li.active {
	color: #fff;
	border-bottom: 2px #ed6663 solid;
}
.multiple_addresses {
    padding: 25px;
    position: relative;
...
.common-home #content  { margin-top:0px!important}
...
.newsletter-wrap button.subscribe:hover {
  transition: all 0.4s cubic-bezier(0.8, 0, 0, 1);
  box-shadow: inset 0 -40px 0 0 #ee061e;
...
button.button:hover {
	...
	-o-transition: all 0.4s cubic-bezier(0.8, 0, 0, 1);
	transition: all 0.4s cubic-bezier(0.8, 0, 0, 1);
	box-shadow: inset 0 -45px 0 0 #e0403d;
	border: 1px solid #e0403d;
	color: #fff;
}
...
.fl-links > .no-js:hover > .clicker {
	...
	-o-transition: all 0.3s cubic-bezier(0.8, 0, 0, 1);
	transition: all 0.3s cubic-bezier(0.8, 0, 0, 1);
	-webkit-box-shadow: inset 0 -85px 0 0 #fff;
	box-shadow: inset 0 -85px 0 0 #fff;
}
...
.add-section {background:#f5f5f5; padding:65px 0px; overflow:hidden}
...
.home-box img{ width:100%; position:relative}

.home-box:last-child{ margin-right:0px}


.home-box .banner-info {position:absolute; bottom:0; background:#ee061e; padding:20px 20px; width:270px;}

.home-box .black{background:#000}

.home-box .small-text {font-family:'Montserrat', sans-serif; font-size:12px; text-transform:uppercase}
.home-box .blog-img {overflow:hidden; position:relative}
.box-img img {
	-webkit-transition-duration: 500ms;
	transition-duration: 500ms;
	-webkit-transition-property: transform;
...
.subscribe {
    ...
    cursor: pointer;
    font-weight: bold;
    border: 2px #ee061e solid !important;
    background: #ee061e;
    font-size: 12px;
    text-align: center;
    white-space: nowrap;
