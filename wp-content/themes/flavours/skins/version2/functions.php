    ...
    <section class="add-section">
          ...
          <div class="box-img">
            ...
            <div class="mask">
              <div class="banner-info">
                <?php if(!empty($flavours_Options['home-offer-banner1-text1'])) { ?>
                <span class="small-text"><?php esc_attr_e($flavours_Options['home-offer-banner1-text1'],'flavours'); ?></span>
                <?php } ?>
                <?php if(!empty($flavours_Options['home-offer-banner1-text2'])) { ?>
                <span><?php esc_attr_e($flavours_Options['home-offer-banner1-text2'],'flavours'); ?></span>
                <?php } ?>
              </div>
            </div>
          </div>
        ...
        <div class="home-box">
          <div class="box-img">
            ...
            <div class="mask">
              <div class="banner-info">
                <?php if(!empty($flavours_Options['home-offer-banner2-text1'])) { ?>
                <span class="small-text"><?php esc_attr_e($flavours_Options['home-offer-banner2-text1'],'flavours'); ?></span>
                <?php } ?>
                <?php if(!empty($flavours_Options['home-offer-banner2-text2'])) { ?>
                <span><?php esc_attr_e($flavours_Options['home-offer-banner2-text2'],'flavours'); ?></span>
                <?php } ?>
              </div>
            </div>
          </div>
        ...
        <div class="home-box">
          <div class="box-img">
            ...
            <div class="mask">
              <div class="banner-info">
                <?php if(!empty($flavours_Options['home-offer-banner3-text1'])) { ?>
                <span class="small-text"><?php esc_attr_e($flavours_Options['home-offer-banner3-text1'],'flavours'); ?></span>
                <?php } ?>
                <?php if(!empty($flavours_Options['home-offer-banner3-text2'])) { ?>
                <span><?php esc_attr_e($flavours_Options['home-offer-banner3-text2'],'flavours'); ?></span>
                <?php } ?>
              </div>
            </div>
          </div>
