...
add_filter( 'wp_setup_nav_menu_item', 'tmFlavours_add_custom_fields' );

function tmFlavours_add_custom_fields( $menu_item ) {
...
add_action( 'wp_update_nav_menu_item', 'tmFlavours_update_custom_fields', 10, 3 );

function tmFlavours_update_custom_fields( $menu_id, $menu_item_db_id, $args ) {
...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'tmFlavours_menu_edit_walker', 10, 2 );

function tmFlavours_menu_edit_walker($walker = '', $menu_id = '') {
    return 'tmFlavours_Walker_Nav_Menu_Edit';
}

// Create HTML list of nav menu input items.
// Extend from Walker_Nav_Menu class
class tmFlavours_Walker_Nav_Menu_Edit extends Walker_Nav_Menu  {
    /**
            ...
            <span class="item-controls">
                ...
                <span class="item-order hide-if-js">
                    <a href="<?php
                        ...
                        ?>" class="item-move-up"><abbr title="esc_attr_e( 'Move up','flavours')">&#8593;</abbr></a>
                    |
                    <a href="<?php
                        echo wp_nonce_url(
                            esc_url( add_query_arg(
                        ...
                        ?>" class="item-move-down"><abbr title="esc_attr_e( 'Move down','flavours')">&#8595;</abbr></a>
                </span>
                <a class="item-edit" id="edit-<?php echo esc_html($item_id); ?>" title="esc_attr_e('Edit Menu Item','flavours')" href="<?php
                    ...
                    ?>"><?php esc_attr_e( 'Edit Menu Item','flavours'); ?></a>
            </span>
        </dt>
    </dl>
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-url-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e('URL','flavours'); ?><br />
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-title-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Navigation Label','flavours'); ?><br />
    ...
    <p class="description">
        <label for="edit-menu-item-target-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( 'Open link in a new window/tab','flavours'); ?>
        </label>
    </p>
    <?php
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-icon-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Font Awesome Icon Class','flavours'); ?><br />
            ...
            <span><?php echo esc_html__('Input font awesome icon or icon class. You can see <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/">Font Awesome Icons in here</a>.', 'flavours') ?></span>
        </label>
    </p>
    <p class="description">
        <label for="edit-menu-item-nolink-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( "Don't link",'flavours'); ?>
        </label>
    </p>
    <p class="description">
        <label for="edit-menu-item-hide-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( "Don't show a link",'flavours'); ?>
        </label>
    </p>
    <p class="description">
        <label for="edit-menu-item-mobile_hide-<?php echo esc_html($item_id); ?>">
            ...
            <?php esc_attr_e( "Don't show a link on mobile panel",'flavours'); ?>
        </label>
    </p>
    <div class="menu-item-level0-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 0) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-thin description-thin-custom">
            <label for="edit-menu-item-type-menu-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Menu Type','flavours'); ?><br />
                <select id="edit-menu-item-type-menu-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_type) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Narrow','flavours'); ?></option>
                    <option value="wide" <?php if(esc_html($item->popup_type) == "wide"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Wide','flavours'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-thin description-thin-custom">
            <label for="edit-menu-item-popup_pos-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Popup Position','flavours'); ?><br />
                ...
                >
                    <option value="pos-left" <?php if(esc_html($item->popup_pos) == "pos-left"){echo 'selected="selected"';} ?>><?php esc_attr_e('Left','flavours') ?></option>
                    <option value="pos-right" <?php if(esc_html($item->popup_pos) == "pos-right"){echo 'selected="selected"';} ?>><?php esc_attr_e('Right','flavours') ?></option>
                    <option value="" <?php if(esc_html($item->popup_pos) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Justify (only for wide)','flavours') ?></option>
                    <option value="pos-center" <?php if(esc_html($item->popup_pos) == "pos-center"){echo 'selected="selected"';} ?>><?php esc_attr_e('Center (only for wide)','flavours') ?></option>
                </select>
            </label>
        </p>
        <div style="clear:both;"></div>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_cols-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Popup Columns (only for wide)','flavours'); ?><br />
                <select id="edit-menu-item-popup_cols-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_cols) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','flavours'); ?></option>
                    <option value="col-2" <?php if(esc_html($item->popup_cols) == "col-2"){echo 'selected="selected"';} ?>><?php esc_attr_e( '2 Columns','flavours'); ?></option>
                    <option value="col-3" <?php if(esc_html($item->popup_cols) == "col-3"){echo 'selected="selected"';} ?>><?php esc_attr_e( '3 Columns','flavours'); ?></option>
                    <option value="col-4" <?php if(esc_html($item->popup_cols) == "col-4"){echo 'selected="selected"';} ?>><?php esc_attr_e( '4 Columns','flavours'); ?></option>
                    <option value="col-5" <?php if(esc_html($item->popup_cols) == "col-5"){echo 'selected="selected"';} ?>><?php esc_attr_e( '5 Columns','flavours'); ?></option>
                    <option value="col-6" <?php if(esc_html($item->popup_cols) == "col-6"){echo 'selected="selected"';} ?>><?php esc_attr_e( '6 Columns','flavours'); ?></option>
                </select>
            </label>
        </p>
    ...
    <div class="menu-item-level1-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 1) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-cols-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Columns (only for wide)','flavours'); ?><br />
                ...
                <span class="description"><?php esc_attr_e('will occupy x columns of parent popup columns','flavours'); ?></span>
            </label>
        </p>
    ...
    <div class="menu-item-level2-<?php echo esc_html($item_id); ?>" style="<?php if ($depth == 0 || $depth == 1) echo 'display:block;'; else echo 'display:none;' ?>">
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Background Image (only for wide)','flavours'); ?><br />
                ...
                <br/>
                <input class="button_upload_image button" id="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>" type="button" value="<?php esc_attr_e('Upload Image','flavours');?>" />&nbsp;
                <input class="button_remove_image button" id="edit-menu-item-popup_bg_image-<?php echo esc_html($item_id); ?>" type="button" value="<?php esc_attr_e('Remove Image','flavours');?>" />
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_pos-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Position (only for wide)','flavours'); ?><br />
                <select id="edit-menu-item-popup_bg_pos-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_pos) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e('Select','flavours'); ?></option>
                    <option value="left top" <?php if(esc_html($item->popup_bg_pos) == "left top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Top','flavours'); ?></option>
                    <option value="left center" <?php if(esc_html($item->popup_bg_pos) == "left center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Center','flavours'); ?></option>
                    <option value="left center" <?php if(esc_html($item->popup_bg_pos) == "left center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Center','flavours'); ?></option>
                    <option value="left bottom" <?php if(esc_html($item->popup_bg_pos) == "left bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Left Bottom','flavours'); ?></option>
                    <option value="center top" <?php if(esc_html($item->popup_bg_pos) == "center top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Top','flavours'); ?></option>
                    <option value="center center" <?php if(esc_html($item->popup_bg_pos) == "center center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Center','flavours'); ?></option>
                    <option value="center bottom" <?php if(esc_html($item->popup_bg_pos) == "center bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Center Bottom','flavours'); ?></option>
                    <option value="right top" <?php if(esc_html($item->popup_bg_pos) == "right top"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Top','flavours'); ?></option>
                    <option value="right center" <?php if(esc_html($item->popup_bg_pos) == "right center"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Center','flavours'); ?></option>
                    <option value="right bottom" <?php if(esc_html($item->popup_bg_pos) == "right bottom"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Right Bottom','flavours'); ?></option>
                    );
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_repeat-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Repeat (only for wide)','flavours'); ?><br />
                <select id="edit-menu-item-popup_bg_repeat-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_repeat) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','flavours'); ?></option>
                    <option value="no-repeat" <?php if(esc_html($item->popup_bg_repeat) == "no-repeat"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'No Repeat','flavours'); ?></option>
                    <option value="repeat" <?php if(esc_html($item->popup_bg_repeat) == "repeat"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat All','flavours'); ?></option>
                    <option value="repeat-x" <?php if(esc_html($item->popup_bg_repeat) == "repeat-x"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat Horizontally','flavours'); ?></option>
                    <option value="repeat-y" <?php if(esc_html($item->popup_bg_repeat) == "repeat-y"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Repeat Vertically','flavours'); ?></option>
                    <option value="inherit" <?php if(esc_html($item->popup_bg_repeat) == "inherit"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Inherit','flavours'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_bg_size-<?php echo esc_html($item_id); ?>">
                <br/><?php esc_attr_e( 'Background Size (only for wide)','flavours'); ?><br />
                <select id="edit-menu-item-popup_bg_size-<?php echo esc_html($item_id); ?>"
                    ...
                    >
                    <option value="" <?php if(esc_html($item->popup_bg_size) == ""){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Select','flavours'); ?></option>
                    <option value="inherit" <?php if(esc_html($item->popup_bg_size) == "inherit"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Inherit','flavours'); ?></option>
                    <option value="cover" <?php if(esc_html($item->popup_bg_size) == "cover"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Cover','flavours'); ?></option>
                    <option value="contain" <?php if(esc_html($item->popup_bg_size) == "contain"){echo 'selected="selected"';} ?>><?php esc_attr_e( 'Contain','flavours'); ?></option>
                </select>
            </label>
        </p>
        <p class="description description-wide">
            <label for="edit-menu-item-popup_style-<?php echo esc_html($item_id); ?>">
                <?php esc_attr_e( 'Custom Styles (only for wide)','flavours'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_label-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip Label','flavours'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_color-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip Text Color','flavours'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-tip_bg-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Tip BG Color','flavours'); ?><br />
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-attr-title-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Title Attribute','flavours'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-classes-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'CSS Classes (optional)','flavours'); ?><br />
    ...
    <p class="description description-thin">
        <label for="edit-menu-item-xfn-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Link Relationship (XFN)','flavours'); ?><br />
    ...
    <p class="description description-wide">
        <label for="edit-menu-item-description-<?php echo esc_html($item_id); ?>">
            <?php esc_attr_e( 'Description','flavours'); ?><br />
            ...
            <span class="description"><?php esc_attr_e( 'The description will be displayed in the menu if the current theme supports it.','flavours');  ?></span>
        </label>
    </p>
    <div class="menu-item-actions description-wide submitbox">
        ...
        <a class="item-delete submitdelete deletion" id="delete-<?php echo esc_html($item_id); ?>" href="<?php
            ...
            ); ?>"><?php esc_attr_e( 'Remove','flavours'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_html($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), esc_url( remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) ) );
        ?>#menu-item-settings-<?php echo esc_html($item_id); ?>"><?php esc_attr_e( 'Cancel','flavours'); ?></a>
    </div>
...
/* Top Navigation Menu */
if (!class_exists('TmFlavours_top_navwalker')) {
    class TmFlavours_top_navwalker extends Walker_Nav_Menu {
...
/* Mobile Menu */
if (!class_exists('TmFlavours_mobile_navwalker')) {
    class TmFlavours_mobile_navwalker extends Walker_Nav_Menu {
