...
?>
  <div class="page-heading">
    ...
    <?php //if($TmFlavours->tmFlavours_page_title()!=''){ ?>
				...
				<?php 	while (have_posts()) : the_post(); ?>
							<article  id="post-<?php echo esc_html($post->ID); ?>" <?php post_class('blog-post container-paper'); ?>>								
								<div class="post-container">
									...
									<ul class="list-info">
										<?php if (!isset($flavours_Options) || $flavours_Options['blog_show_post_by'] == 1 ) { ?>
											<li><i class="fa fa-user"></i><?php esc_attr_e('By', 'flavours'); ?>  <?php the_author(); ?>	</li>
											<li class="divider">|</li>
										<?php } ?>
										<?php if(!isset($flavours_Options) ||  $flavours_Options['blog_display_category']==1) {  if(has_category()){
											...
											<li class="divider">|</li>
											 <?php } } ?>
												...
												<?php if (!isset($flavours_Options) || $flavours_Options['blog_display_view_counts'] == 1) { ?>
													<li><i class="fa fa-eye"></i><?php echo $TmFlavours->tmFlavours_getPostViews(get_the_ID()); ?> </li>
													<li class="divider">|</li>
												<?php } ?>
												<?php if (!isset($flavours_Options) || $flavours_Options['blog_display_comments_count'] == 1) { ?>
