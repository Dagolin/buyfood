    ...
    <form action="<?php echo admin_url('admin.php?page=wf_woocommerce_csv_im_ex&action=export'); ?>" method="post">
        ...
        <table class="form-table">
            ...
            <table id="datagrid">
                ...
                <?php 
                $post_columns['images'] = '圖片';
                $post_columns['file_paths'] = '可下載檔路徑';
                $post_columns['taxonomies'] = '(類別/tags/貨運類)';
                $post_columns['attributes'] = '屬性';
                ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                     <input type="text" name="columns_name[<?php echo $pkey; ?>]"  value="<?php echo $pcolumn; ?>" class="input-text" />
                </td>
            </tr>
                <?php } ?>
